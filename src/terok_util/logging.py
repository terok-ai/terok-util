...
It lives here — at the bottom of the dependency chain — so every
sibling (sandbox, executor, shield, clearance, terok) can drop its own
near-identical copy and import this instead.
...
class BestEffortLogger:
    ...
    behaviour of the module-level helpers this class replaces.
